...
public class ObiecteFragment extends Fragment {
    private TextView obiectEngleza;
    private TextView obiectRomana;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        obiectRomana = view.findViewById(R.id.cuvantRomana);
        obiectEngleza = view.findViewById(R.id.cuvantEngleza);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        textToSpeechButton();
        initTextToSpeech();
        obiectEngleza.setText(obiecteEnglezaArray.get(i));
        obiectRomana.setText(obiecteRomanaArray.get(i));
        avanseazaButton();
    ...
    private void textToSpeechButton() {
        TTS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String data = obiectEngleza.getText().toString();
