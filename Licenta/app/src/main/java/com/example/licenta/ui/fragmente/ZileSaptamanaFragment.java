...
public class ZileSaptamanaFragment extends Fragment {
    private TextView zileEngleza;
    private TextView zileRomana;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        progressBar.setMax((zileEnglezaArray.size() / zileEnglezaArray.size()) * 100);
    ...
    private void textToSpeechButton() {
        TTS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String data = zileEngleza.getText().toString();
            ...
            public void onClick(View view) {
                if (verificare.getCurrentTextColor() == Color.GREEN) {
                    ...
                    if (i >= zileEnglezaArray.size()) {
                        progressBar.setProgress((zileEnglezaArray.size() / zileEnglezaArray.size()) * 100);
                        ...
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                progress = (i / zileEnglezaArray.size());
