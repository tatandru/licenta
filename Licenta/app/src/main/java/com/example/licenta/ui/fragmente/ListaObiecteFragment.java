...
public class ListaObiecteFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
             bundleRo = getArguments().getBundle("bundleObiecteRo");
             bundleEn = getArguments().getBundle("bundleObiecteEn");
    ...
    private void setupList() {
        ...
        adapter = new CuvinteRecyclerView(obiecteRomanaArray, getContext());
        adapter.setCategoryClickListener(new CuvinteRecyclerView.ItemClickListener() {
            @Override
            public void onClick(String cuvant,int pos) {

                Bundle bundle = new Bundle();
                bundle.putBundle("bundleObiecteRo", bundleRo);
                bundle.putBundle("bundleObiecteEn", bundleEn);
                bundle.putInt("pozitie",pos);
                navController.navigate(R.id.action_listaObiecteFragment_to_obiecteFragment,bundle);
            }
        });
        recyclerView.setAdapter(adapter);
    }
